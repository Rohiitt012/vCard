  ...
  return (
    <header className="sticky top-0 flex w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-b border-gray-200/80 dark:border-gray-800/80 z-99999 shadow-[var(--shadow-premium-sm)]">
        ...
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 sm:px-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 min-h-[3.25rem] sm:min-h-0">
          <button
            className="flex items-center justify-center min-w-[2.75rem] min-h-[2.75rem] w-10 h-10 text-gray-500 border border-gray-200 rounded-lg z-99999 dark:border-gray-800 dark:text-gray-400 lg:hidden touch-manipulation"
          ...
          <button
            ...
            className="flex items-center justify-center min-w-[2.75rem] min-h-[2.75rem] w-10 h-10 text-gray-700 rounded-lg z-99999 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden touch-manipulation"
          >
            <svg
              width="24"
              height="24"
