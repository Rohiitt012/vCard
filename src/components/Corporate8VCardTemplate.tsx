        ...
        {(!card.manageSection || card.manageSection.testimonials) && (
            <section className="px-8 pb-16 relative z-10 animate-in fade-in slide-in-from-bottom-10 duration-700">
                ...
                <div className="relative pt-10">
                    {/* Outer White Card */}
                    <div className="bg-white rounded-[40px] border border-[#D2B48C]/30 p-8 shadow-xl flex flex-col items-center relative group transition-all duration-500 hover:-translate-y-2">
