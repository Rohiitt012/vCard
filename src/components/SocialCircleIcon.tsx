...
export const SocialCircleIcon = ({ platform, url, size = 36 }: SocialCircleIconProps) => {
  ...
  const content = (() => {
    switch (id) {
      case "website":
        return (
          <div className={`${base} bg-blue-500`} style={style}>
      ...
      case "facebook":
        return (
          <div className={`${base} bg-[#1877F2]`} style={style}>
      ...
      case "reddit":
        return (
          <div className={`${base} bg-[#FF4500]`} style={style}>
            <svg style={{ width: iconSize, height: iconSize }} fill="currentColor" viewBox="0 0 24 24">
      ...
      case "youtube":
        return (
          <div className={`${base} bg-[#FF0000]`} style={style}>
            <svg style={{ width: iconSize, height: iconSize }} fill="currentColor" viewBox="0 0 24 24">
      ...
      case "whatsapp":
        return (
          <div className={`${base} bg-[#25D366]`} style={style}>
            <svg style={{ width: iconSize, height: iconSize }} fill="currentColor" viewBox="0 0 24 24">
      ...
      case "tiktok":
        return (
          <div className={`${base} bg-black`} style={style}>
            <svg style={{ width: iconSize, height: iconSize }} fill="currentColor" viewBox="0 0 24 24">
      ...
      case "instagram":
        return (
          <div className={`${base} bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737]`} style={style}>
            <svg style={{ width: iconSize, height: iconSize }} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      case "linkedin":
        return (
          <div className={`${base} bg-[#0A66C2]`} style={style}>
            <svg style={{ width: iconSize, height: iconSize }} fill="currentColor" viewBox="0 0 24 24">
      ...
      default:
        return (
          <div className={`${base} bg-gray-400`} style={style}>
