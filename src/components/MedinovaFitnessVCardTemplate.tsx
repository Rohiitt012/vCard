        ...
        <section className="px-4 sm:px-6 py-8 bg-slate-50 border-t border-slate-100">
          ...
          <div className="grid gap-4 md:grid-cols-3 text-[13px]">
            {[
              {
                name: "Akash",
                text: "Lost 8kg in 3 months while improving overall strength and energy.",
              },
              {
                name: "Neha",
                text: "Sessions are challenging but safe. Programming feels tailored to my lifestyle.",
              },
              {
                name: "Rohan",
                text: "Great balance of strength, conditioning and mobility. I feel stronger and pain‑free.",
              },
            ].map((t) => (
              <div
                key={t.name}
