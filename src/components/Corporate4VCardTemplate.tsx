...
export function Corporate4VCardTemplate({ card, slug, baseUrl, onDownloadVCard }: Props) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex justify-center px-0 py-0 overflow-x-hidden relative">
      <div className="w-full max-w-[540px] bg-white relative flex flex-col shadow-2xl overflow-hidden">
        ...
        <section className="px-8 -mt-32 relative z-10 mb-8">
            <div className="flex flex-row items-start gap-8">
                ...
                <div className="pt-24 space-y-5 flex-1">
                    <div className="space-y-1 relative">
                        {/* Title Watermark Overlay for the name area */}
                        <div className="absolute -top-10 -left-4 select-none opacity-[0.04] text-[60px] font-black text-[#2C5F56] pointer-events-none z-0 whitespace-nowrap leading-none">
                            {name}
                        </div>
                        <h1 className="text-[38px] font-black text-[#1A4D4E] tracking-tight leading-[1.1] text-left relative z-10">
                            {name}
                        </h1>
                        <p className="text-[17px] font-bold text-[#5A9294] tracking-wide text-left uppercase relative z-10">
                            {role}
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        {[
                          { p: 'facebook', d: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" },
                          { p: 'whatsapp', d: "M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" },
                          { p: 'linkedin', d: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" },
                          { p: 'instagram', isInsta: true }
                        ].map((item) => (
                            <div key={item.p} className="w-12 h-12 rounded-full border border-[#2C5F56]/60 flex items-center justify-center text-[#2C5F56] hover:bg-[#2C5F56] hover:text-white transition-all duration-300 cursor-pointer group">
                                {item.isInsta ? (
            ...
            <div className="grid grid-cols-2 gap-5">
                {[
                    ...
                    <div key={idx} className="group relative">
                        ...
                        <div className="absolute -inset-1 bg-gradient-to-r from-[#2C5F56]/10 to-transparent rounded-full blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        
                        <div className="relative bg-[#F1F7F4] rounded-full py-5 px-7 flex items-center gap-4 transition-all duration-300 hover:bg-white hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-1 border border-transparent hover:border-[#2C5F56]/10 cursor-pointer">
                            <item.icon className="w-5.5 h-5.5 text-[#2C5F56] shrink-0 opacity-80 group-hover:opacity-100" />
        ...
        <section className="px-8 pb-16 relative overflow-visible">
            ...
            <div className="text-center mb-10 relative z-10">
                <h2 className="text-[28px] font-black text-[#1A4D4E] uppercase tracking-[0.2em]">Our Services</h2>
            ...
            <div className="grid grid-cols-2 gap-6 relative z-10">
                {(card.services && card.services.length > 0 ? card.services : DEFAULT_SERVICES).map((service, idx) => (
                    <div key={idx} className="bg-white rounded-[40px] p-4 flex flex-col items-start text-left shadow-[0_20px_40px_rgba(0,0,0,0.04)] border border-slate-50 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 group">
                        <div className="relative w-full aspect-square rounded-[30px] overflow-hidden mb-8 shadow-inner bg-slate-100">
                            <Image 
        ...
        <section className="px-8 pb-16 relative overflow-visible">
            <div className="text-center mb-10 relative z-10">
                <h2 className="text-[28px] font-black text-[#1A4D4E] uppercase tracking-[0.2em]">Latest Blogs</h2>
                <div className="w-12 h-1 bg-[#2C5F56]/20 mx-auto mt-4 rounded-full" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 relative z-10">
                {(card.blogs && card.blogs.length > 0 ? (card.blogs as any[]) : DEFAULT_BLOGS).map((blog, idx) => (
                    <div key={idx} className="bg-white rounded-[40px] p-4 flex flex-col items-start text-left shadow-[0_20px_40px_rgba(0,0,0,0.04)] border border-slate-50 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 group">
                        <div className="relative w-full aspect-[4/5] rounded-[30px] overflow-hidden mb-8 shadow-inner bg-slate-100">
                            <Image 
        ...
        <section className="px-8 pb-16 relative overflow-visible">
            ...
            <div className="text-center mb-10 relative z-10">
                <h2 className="text-[28px] font-black text-[#1A4D4E] uppercase tracking-[0.2em]">Testimonial</h2>
                <div className="w-12 h-1 bg-[#2C5F56]/20 mx-auto mt-4 rounded-full" />
            </div>

            <div className="grid grid-cols-2 gap-6 relative z-10">
                {(card.testimonials && card.testimonials.length > 0 ? (card.testimonials as any[]) : DEFAULT_TESTIMONIALS).map((t, idx) => (
                    <div key={idx} className="bg-white rounded-[32px] p-8 flex flex-col items-center text-center shadow-[0_15px_35px_rgba(0,0,0,0.03)] border border-slate-50 transition-all hover:shadow-xl group">
                        <div className="relative w-24 h-24 rounded-full overflow-hidden mb-10 border-4 border-slate-50 shadow-sm">
                            <Image 
        ...
        <section className="bg-[#E2F0E5] pt-16 pb-20 relative overflow-hidden">
            ...
            <div className="absolute right-6 -top-20 flex flex-col items-center gap-4 z-20">
                <div className="w-16 h-16 rounded-full bg-white shadow-xl flex items-center justify-center border border-slate-100 hover:scale-110 active:scale-95 transition-transform cursor-pointer overflow-hidden">
                ...
                {/* Large Menu Icon with Gradient */}
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#1A4D4E] to-[#2C5F56] shadow-2xl flex items-center justify-center -mr-16 scale-110 active:scale-100 transition-transform cursor-pointer border-4 border-white/20">
                    <svg className="w-10 h-10 text-white" stroke="currentColor" fill="none" strokeWidth={2} viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/></svg>
                </div>

                <div className="w-16 h-16 rounded-full bg-white shadow-xl flex items-center justify-center border border-slate-100 scale-110 hover:scale-[1.2] active:scale-95 transition-transform cursor-pointer">
                    <svg className="w-8 h-8 text-[#2C5F56]" stroke="currentColor" fill="none" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m.496-1.638A4.002 4.002 0 0115 10c1.391 0 2.624.707 3.354 1.776M9.18 14.98a4.002 4.002 0 01-3.354-1.776m12.748 0A4.002 4.002 0 0115 14c-1.391 0-2.624-.707-3.354-1.776M9 12c0 .482.114.938.316 1.342m-.496-1.638A4.002 4.002 0 003 12c0 2.209 1.791 4 4 4 1.104 0 2.103-.447 2.828-1.171M9 12c0-.482-.114-.938-.316-1.342m.496 1.638A4.002 4.002 0 0115 14h6.5M3 12h6.5m0 0a4.002 4.002 0 013.354-1.776M15 10a4 4 0 100-8 4 4 0 000 8zm0 12a4 4 0 100-8 4 4 0 000 8z" /></svg>
                </div>
            </div>
        ...
        <section className="px-8 pb-16 relative overflow-visible">
            <div className="text-center mb-10 relative z-10">
                <h2 className="text-[28px] font-black text-[#1A4D4E] uppercase tracking-[0.2em]">Our Business Hours</h2>
                <div className="w-12 h-1 bg-[#2C5F56]/20 mx-auto mt-4 rounded-full" />
            </div>
            ...
            <div className="space-y-4 relative z-10">
                {(card.businessHours 
                  ...
                  : DEFAULT_BUSINESS_HOURS
                    ...
                    <div key={idx} className="bg-white rounded-[24px] p-4 flex items-center gap-6 shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-slate-50 border-b-2 hover:shadow-xl hover:-translate-y-1 transition-all group">
                        <div className="w-16 h-16 rounded-[18px] bg-[#2C5F56] flex items-center justify-center text-white shrink-0 group-hover:scale-110 transition-transform">
        ...
        <section className="px-8 pb-16 relative overflow-visible">
            <div className="text-center mb-10 relative z-10">
                <h2 className="text-[28px] font-black text-[#1A4D4E] uppercase tracking-[0.2em]">Contact Us</h2>
                <div className="w-12 h-1 bg-[#2C5F56]/20 mx-auto mt-4 rounded-full" />
            </div>
            ...
            <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                <div className="space-y-5">
                    <input 
                        ...
                        className="w-full bg-white border border-slate-200 rounded-[20px] px-8 py-5 text-[15px] font-bold text-slate-700 placeholder:text-slate-300 focus:outline-none focus:border-[#2C5F56] transition-colors shadow-sm"
                    />
                    <input 
                        type="email" 
                    ...
                    <textarea 
                        ...
                        rows={6}
                        className="w-full bg-white border border-slate-200 rounded-[30px] px-8 py-6 text-[15px] font-bold text-slate-700 placeholder:text-slate-300 focus:outline-none focus:border-[#2C5F56] transition-colors shadow-sm resize-none"
                    ></textarea>
                </div>
        ...
        <section className="px-8 pb-20 relative overflow-visible">
            <div className="text-center mb-10 relative z-10">
                <h2 className="text-[28px] font-black text-[#1A4D4E] uppercase tracking-[0.2em]">Create Your VCard</h2>
                <div className="w-12 h-1 bg-[#2C5F56]/20 mx-auto mt-4 rounded-full" />
            </div>
            ...
            <div className="space-y-12 relative z-10 flex flex-col items-center">
                ...
                <a 
                    ...
                    className="w-full bg-[#F1F7F4] rounded-[24px] py-6 px-10 flex items-center justify-between group cursor-pointer transition-all hover:bg-white hover:shadow-xl hover:shadow-slate-200/50 border border-transparent hover:border-[#2C5F56]/10"
                >
